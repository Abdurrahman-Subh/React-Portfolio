...
import styles from '../styles/Footerr.css';
                 ...
                 <div className="row ">
                     ...
                     <div className="col-xl-2 col-md-4 col-sm-4 col-12">
                         ...
                         <ul className="list-unstyled">
                             ...
                             <li><a href="https://www.instagram.com/abdurrahman_subh/" target="_blank">Instagram</a></li>
                             <li><a href="https://api.whatsapp.com/send?phone=905388817072" target="_blank">Whats'App</a></li>
                            
                         </ul>
                     </div>
                     <div className="col-xl-2 col-md-4 col-sm-4 col-12">
                         <h6 className="mb-3 mb-lg-4 text-muted bold-text mt-sm-0 mt-5"><b>ADDRESS</b></h6>
                         <p className="mb-1">Başakşehir, Istanbul</p>
                         
                     </div>
                 </div>
                 <div className="row ">
                     <div className="col-xl-8 col-md-4 col-sm-4 col-auto my-md-0 mt-5 order-sm-1 order-3 align-self-end">
                         <p className="social text-muted mb-0 pb-0 bold-text"> <span className="mx-2"><i className="fa fa-facebook" aria-hidden="true"></i></span> <span className="mx-2"><i className="fa fa-linkedin-square" aria-hidden="true"></i></span> <span className="mx-2"><i className="fa fa-twitter" aria-hidden="true"></i></span> <span className="mx-2"><i className="fa fa-instagram" aria-hidden="true"></i></span> </p><small className="rights"><span>&#174;</span> Abduurahman All Rights Reserved.</small>
                     </div>
                     <div className="col-xl-2 col-md-4 col-sm-4 col-auto order-1 align-self-end ">
                         <h6 className="mt-55 mt-2 text-muted bold-text"><b>Abdurrahman Subh</b></h6><small> <span><i class="fa fa-envelope" aria-hidden="true"></i></span> omer.subohh@gmail.com</small>
                     </div>
